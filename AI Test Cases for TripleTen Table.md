...
| :--- | :--- | :--- | :--- | :--- | :--- | :---: | :---: |
| **TC-001** | REQ-001 | Reject Non-Numeric Input | `A! @` | 1. Click on the "Card number (not yours):" input field.<br>2. Type alphabetical character "A".<br>3. Type special characters "! @".<br>4. Observe the field. | The field rejects the input. No characters appear. The input field remains completely empty. | [ ] | [ ] |
